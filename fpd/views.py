...
import joblib
file_path = '/kaggle/input/social-media-test/social_media_test.csv'
...
def instagram(request):
    ...
    # def extract_username_and_platform(url):
    # url_parts = url.split('/')
    
    # for part in url_parts:
    #     if part and not part.startswith('?'):
    #         if 'instagram' in part.lower():
    #             return part, 'Instagram'
    #         elif 'facebook' in part.lower():
    #             return part, 'Facebook'
